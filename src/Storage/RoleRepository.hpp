...
public:
    ...
    bool saveRole(Core::Snowflake guildId, const Discord::Role &role, QSqlDatabase &db);
    bool saveRoles(Core::Snowflake guildId, const QList<Discord::Role> &roles, QSqlDatabase &db);
